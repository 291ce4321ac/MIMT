...
%     'psnr' calculates the peak signal-noise ratio. In this case, A is the image 
%            under test, and B is the reference.  When using the 'native' option, 
